  ...
  (function() {
    ...
    async function copyPresentationLink() {
      ...
      try {
        ...
        showToast("Lien copi\xE9 dans le presse-papiers");
      } catch {
        showToast(url);
      }
    }
    async function sharePresentation() {
      const url = presentationUrl();
      const shareData = {
        title: "Le Sourire de JoJo \u2014 Pr\xE9sentation",
        text: "D\xE9couvrez la pr\xE9sentation du projet Le Sourire de JoJo (10 slides).",
        url
      };
      if (navigator.share) {
        try {
